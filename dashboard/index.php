                            ...
                            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                                ...
                                <div class="block w-full overflow-x-auto">
                                    <table class="items-center w-full bg-transparent border-collapse">
                                        ...
                                        $sql = "SELECT * FROM review WHERE status = 'pending' ORDER BY id DESC LIMIT 3";
                                        $result = mysqli_query($conn, $sql);
                                        ...
                                        if ($resultCheck > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                $sql3 = "SELECT * FROM users WHERE id = '$faculty'";
                                                $result3 = mysqli_query($conn, $sql3);
                                                $row3 = mysqli_fetch_assoc($result3);
                                                $facultyName = $row3['username'];
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                                                            <img src="https://avatars.dicebear.com/api/bottts/<?php echo $studentName; ?>.png" class="h-12 w-12 bg-white rounded-full border" alt="..." />
                            ...
                            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                                ...
                                <div class="block w-full overflow-x-auto">
                                    <table class="items-center w-full bg-transparent border-collapse">
                                        ...
                                        $sql = "SELECT * FROM appointments WHERE f_id = '$id' AND status = 'pending' ORDER BY date, time ASC LIMIT 3";
                                        $result = mysqli_query($conn, $sql);
                                        $resultCheck = mysqli_num_rows($result);
                                        if ($resultCheck > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
