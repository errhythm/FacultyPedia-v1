        ...
        <div class="relative md:ml-64 bg-blueGray-50 max-h-screen">
            ...
            <div class="relative bg-pink-600 md:pt-32 pb-32 pt-12">
                <div class="px-4 md:px-10 mx-auto w-full">
                    <div>
                        <!-- heading that the page is users -->
                        <h1 class="text-white text-2xl font-bold text-center">Users</h1>
                    </div>
                </div>
            </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                                                        <img src="https://avatars.dicebear.com/api/bottts/<?php echo $username; ?>.png" class="h-12 w-12 bg-white rounded-full border" alt="..." />
                                                        <span class="ml-3 font-bold text-blueGray-600">
                                                            <?php echo $username; ?>
                                                        </span>
                                                    </th>
                                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"><?php echo $user_email; ?></td>
                                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        <div class="badge badge-secondary rounded-xl"><?php echo $user_role; ?></div>
                                                    </td>
                                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        <span class="ml-3 font-bold text-blueGray-600"><?php echo $user_fullname; ?></span>
                                                    </td>
                                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        <span class="ml-3 font-bold text-blueGray-600"><?php echo $user_department; ?></span>
                                                    </td>
                                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                                                        <a href="#" class="text-blueGray-500 block py-1 px-3" onclick="openDropdown(event,'table-review-<?php echo $user_id; ?>-dropdown')">
                                                            <i class="fas fa-ellipsis-v"></i>
                                                        </a>
                                                        <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg min-w-48" id="table-review-<?php echo $user_id; ?>-dropdown">
                                                            <a href="../dashboard/edit-users.php?id=<?php echo $user_id; ?>" class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-black-700">Edit</a>
                                                            <a href="../components/pending-review.php?rev_id=<?php echo $user_id; ?>&status=rejected" class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-red-700">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
