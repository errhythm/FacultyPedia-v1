          ...
          <div class="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center">
            ...
            <div class="md:w-5/12 w-full md:pl-9 max-w-sm mx-auto space-y-5 md:inline-flex pl-2">
              <div class="rating rating-lg rating-half">
                ...
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-1" value="0.5" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-2" value="1" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-1" value="1.5" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-2" value="2" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-1" value="2.5" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-2" value="3" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-1" value="3.5" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-2" value="4" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-1" value="4.5" />
                <input type="radio" name="rating-10" class="bg-green-500 mask mask-star-2 mask-half-2" value="5" />
              </div>
            </div>
